...
Public Class ADMIN
    ...
    Private Sub Button1_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button1.Click
        ...
        rd.Read()
        If rd.HasRows Then
            Dim EditData As String = "Update admin set nama='" & TextBox2.Text & "',status='" & TextBox3.Text & "',password='" & TextBox4.Text & "' where idadmin='" & TextBox1.Text & "'"
    ...
    Private Sub TextBox5_KeyPress(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyPressEventArgs) Handles TextBox5.KeyPress
        If e.KeyChar = Chr(13) Then
            ...
            If rd.HasRows Then
                ...
                TextBox3.Text = rd.Item("status")
                TextBox4.Text = rd.Item("password")
            ElseIf Not rd.HasRows Then
